...
def generate_roaData(asn: str, prefix: str, mask: str, max_length: str) -> str:
    ...
    # Change to 520 insead of 416 when going into prod
    expire = create + timedelta(weeks=416)
...
def roa_request(signature: str, roaData: str) -> str:
    ...
    url = f'https://reg.ote.arin.net/rest/roa/{args.orgid};resourceClass={resource_class}?apikey={args.apikey}'
    if args.debug:
